defmodule ConduitWeb.ArticleControllerTest do
  ...
  @create_attrs %{author_bio: "some author_bio", author_image: "some author_image", author_username: "some author_username", author_uuid: "7488a646-e31f-11e4-aace-600308960662", body: "some body", description: "some description", favorite_count: 42, slug: "some slug", tags: [], title: "some title"}
